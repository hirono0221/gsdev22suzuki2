...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('template//ionicons/dist/css/ionicons.min.css')}}">
        <link rel="stylesheet" href="{{asset('template//perfect-scrollbar/css/perfect-scrollbar.css')}}">
